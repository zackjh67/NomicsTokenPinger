...
const filter = argv.furtherFilterBy;
// sorts results by 'rank' or 'first_priced_at'
const sort = argv['sortBy'];
...
(async () => {
    if (argv.helpme) {
        ...
        const argObj = {key, ids, interval, convert, status, filter, sort, includeTransparency, perPage, page};
        console.log(_.keys(argObj).join(' | '));
